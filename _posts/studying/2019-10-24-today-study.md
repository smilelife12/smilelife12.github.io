...
![single rotation]({{src.url}}/assest/img/posting1024/img1.png)

이는 반대 쪽에 추가했을 때는 반대로 돌려주며 이를 left/right rotation 이라 한다.
![single rotation]({{src.url}}/assest/img/posting1024/img2.gif)
...
**시나리오별 rotation**  
총 4개의 시나리오를 정리해보면
![시나리오]({{src.url}}/assest/img/posting1024/img3.png)  
